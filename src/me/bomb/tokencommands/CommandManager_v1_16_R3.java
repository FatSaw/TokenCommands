...
final class CommandManager_v1_16_R3 extends CommandManager {
	
	protected CommandManager_v1_16_R3() {
		outchatpacket = new PacketPlayOutChat(IChatBaseComponent.ChatSerializer.a("{\"text\":\"\"}"),ChatMessageType.SYSTEM,UUID.randomUUID());
	}
        ...
        public void write(ChannelHandlerContext context, Object packet, ChannelPromise channelPromise) throws Exception {
        	if(packet instanceof PacketPlayOutChat) {
            	...
            	if(info.c()) {
            		...
            		TokenMessage tm = JsonManager.write(player.getUniqueId(), packetdataserializer.e(32767));
                	if(tm!=null) {
	                	packetdataserializer.a(tm.msg);
	                    packetdataserializer.writeByte(packetdataserializer.readByte());
	                    packetdataserializer.a(packetdataserializer.k());
